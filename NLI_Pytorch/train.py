...
class Train():
    def __init__(self):
        ...
        print('Dataset preparation done!!! Some overview of the data and tokens are given...')
        print('Topkens with top occurrences!!!')
        print(self.dataset.top_frequency_token())
        print(self.dataset.get_label_count())
        
        print('Overview of top element of dictionary')
        #print(self.dataset.get_top_k_text_stoi(10))
        print(self.dataset.get_top_k_text_itos(10))
        print(self.dataset.get_label_itos())
        print(self.dataset.get_top_k_vectors(10))
        ...
        print('Model is loaded in device ', self.device)
    ...
    def validate(self):
        ...
        with torch.no_grad():
            for batch_idx, batch in enumerate(self.dataset.dev_iter):
                answer = self.model(batch)
                #print('val answer size ', answer.size())
                #print('val label size ', batch.label.size())
                loss = self.criterion(answer, batch.label)
    ...
    def execute(self):
        ...
        for epoch in range(1, self.args.epochs+1):
            ...
            print('| Epoch {:3d} | train_loss {:5.2f} | train_acc {:5.2f} | val loss {:5.2f} | val acc {:5.2f} | time: {:5.2f}s |'.format(
