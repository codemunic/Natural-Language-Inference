...
class SNLI():
    def __init__(self,options):
        ...
        vector_cache_loc = '.vector_cache/snli_vectors.pt' #pytorch use pickle
        ...
        self.train_iter, self.dev_iter, self.test_iter = Iterator.splits((self.train, self.dev, self.train),
